...
begin
  ...
  if current_organization_id is null then
    ...
    insert into public.organizations(name) values ('Liconex')
  ...
  insert into public.project_documents(
    id, organization_id, owner_id, share_token, payload, updated_at
  )
  values (
    project_id, current_organization_id, current_user_id,
    project_share_token, project_payload, project_updated_at
  )
